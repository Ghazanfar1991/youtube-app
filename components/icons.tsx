...
export const ThumbGeniusLogo: React.FC<IconProps> = (props) => (
...
export const Wand2: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m3 21 18-18L3 21"/><path d="M11.5 2.5 13 4l-2.5 2.5L9 5l2.5-2.5"/><path d="M14.5 5.5 16 7l-2.5 2.5L12 8l2.5-2.5"/><path d="M20 13.5 21.5 15l-2.5 2.5L17.5 16l2.5-2.5"/><path d="M6.5 11.5 8 13l-2.5 2.5L4 14l2.5-2.5"/></svg>
);
...
export const Youtube: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2.5 17a24.12 24.12 0 0 1 0-10C2.5 6 7.5 4 12 4s9.5 2 9.5 3a24.12 24.12 0 0 1 0 10c0 1-5 3-9.5 3s-9.5-2-9.5-3Z"/><path d="m10 15 5-3-5-3z"/></svg>
);
...
export const Twitter: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.9 3.3 4.9-6.1-1.4-6.1-1.4s-2.1 6.1-8.3 6.1c-7.5 0-11.3-5.9-11.3-5.9s2.4.5 4.6.1c-2.4-.5-4.6-2.5-4.6-2.5s-.5-2.4 2.4-1.4c-2.1-.5-3.3-2.5-3.3-2.5s1 .5 2.1.5c-2.1-1.4-2.4-4.2-2.4-4.2s2.9 4.9 8.3 4.9c.5-2.4 2.4-4.2 4.6-4.2s3.3 2.1 3.3 2.1" />
    </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M22.56 12.25C22.56 11.45 22.49 10.68 22.36 9.92H12V14.48H18.19C17.93 15.99 17.09 17.29 15.84 18.11V20.72H19.64C21.56 18.97 22.56 16.03 22.56 12.25Z" fill="#4285F4"/>
        <path d="M12 23C15.09 23 17.72 21.94 19.64 20.72L15.84 18.11C14.84 18.79 13.54 19.21 12 19.21C9.22 19.21 6.81 17.43 5.92 14.99H2.02V17.6C3.93 20.79 7.64 23 12 23Z" fill="#34A853"/>
        <path d="M5.92 14.99C5.67 14.28 5.53 13.54 5.53 12.77C5.53 11.99 5.67 11.25 5.92 10.54V7.94H2.02C1.26 9.4 0.83 11.04 0.83 12.77C0.83 14.5 1.26 16.14 2.02 17.6L5.92 14.99Z" fill="#FBBC05"/>
        <path d="M12 6.34C13.62 6.34 15.01 6.92 15.84 7.72L19.73 3.91C17.72 2.09 15.09 1 12 1C7.64 1 3.93 3.21 2.02 6.4L5.92 8.94C6.81 6.5 9.22 4.72 12 4.72V6.34L12 6.34Z" fill="#EA4335"/>
    </svg>
);
